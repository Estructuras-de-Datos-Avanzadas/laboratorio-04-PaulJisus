...
Original file is located at
    https://colab.research.google.com/drive/1cR59lcTkBUjG3OIBMT0U3lLE-PbUtMyK
"""
...
class OctreeQuantizer(object):
    ...
    def reconstruction (self,w, h,pixels,palette):
        ...
        display(out_image)
        out_image.save('salida.jpg')

from PIL import Image

def main():
    image = Image.open('cafe-terrace-van-gogh.jpg')
    pixels = image.load()
    ...
    resized_im = palette_image.resize((round(palette_image.size[0]*5), round(palette_image.size[1]*5)))
    resized_im.save('palette.jpg')
